...
<jsp:useBean id="kakaocertService" scope="application" class="com.barocert.KakaocertServiceImp"/>

<%-- 링크아이디 --%>
<jsp:setProperty name="kakaocertService" property="linkID" value="BKAKAO"/>
